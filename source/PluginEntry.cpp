/**
	...
	`CFFGLPluginInfo` that Instant.cpp registers at static-initialisation
	...
	binary: which build it is.
		...
		strings Instant.bundle/Contents/MacOS/Instant | grep instant
*/

extern "C" const char* InstantBuildStamp()
{
	return "instant " INSTANT_VERSION " built " __DATE__ " " __TIME__;
}
